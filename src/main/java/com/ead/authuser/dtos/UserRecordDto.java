...
public record UserRecordDto(
                            ...
                            @Size(min = 6, max = 20, groups = {UserView.RegistrationPost.class, UserView.PasswordPut.class}, message = "Size msust be between 6 and 20")
                            ...
                            @Size(groups = UserView.PasswordPut.class, min = 6, max = 20, message = "Size msust be between 6 and 20")
